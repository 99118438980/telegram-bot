...
async def ask_command(message: types.Message):
    ...
    await message.answer(
        ...
        "<i>Пусть Аллах благословит вас за ваш вопрос 🤲.</i>"
    )
...
async def feedback_command(message: types.Message):
    ...
    await message.answer(
        "✨ <b>Напишите свои пожелания , предложения или советы для нашей команды.</b>\n"
        "Мы стараемся улучшаться, и ваши слова важны для нас.</b>\n"       
        "<i>Пусть Аллах вознаградит вас за искренность и заботу об о нашей Умме!</i>"
    )
